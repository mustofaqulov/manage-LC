...
import type { TestListResponse, CefrLevel, SectionResponse } from '../api/types';
    ...
    <div className="relative min-h-screen py-20 sm:py-28 md:py-36 px-4 sm:px-6 md:px-12 overflow-hidden bg-[#050505]">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-black mb-4 bg-gradient-to-r from-orange-500 via-amber-400 to-orange-400 bg-clip-text text-transparent">
            Custom Exam
          </h1>
